---
title: "블로그 구글 검색 노출 설정 + 댓글 알림 구현"
date: 2026-05-06T10:00:00Z
category: 블로그
tags: [블로그, SEO, Google Search Console, Resend, Next.js]
excerpt: "Next.js 블로그를 구글에 노출시키는 방법과 Resend로 댓글 알림 이메일을 보내는 방법을 정리했다."
draft: false
---

블로그를 만들고 나서 두 가지가 신경 쓰였다. 구글에서 내 글이 검색되는지, 그리고 누군가 댓글을 달았을 때 알 수 있는지.

이 글은 그 두 가지를 해결한 과정을 기록한다.
